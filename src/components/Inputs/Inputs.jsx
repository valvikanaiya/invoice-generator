export default function Inputs({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center mb-2">
      <input
        className="text-right py-2 px-3 border border-transparent hover:border-gray-200 text-sm text-gray-600 font-light rounded focus:outline-gray-200 focus:outline-1"
        type="text"
        name={labelName}
